    ...
    return (
        ...
        < OrderStyles onSubmit={submitOrder}>
            <fieldset disabled={loading} >
                ...
                <input type='text' name='name' id='name' value={values.name} onChange={updateValue} ></input>
                <label htmlFor='email'>Email</label>
                <input type='email' name='email' id='email' value={values.email} onChange={updateValue}></input>
            <input 
                   type='mapleSyrup' 
                   name='mapleSyrup' 
                   id='mapleSyrup' 
